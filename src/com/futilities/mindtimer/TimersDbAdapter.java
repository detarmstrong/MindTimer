...
public class TimersDbAdapter {
    ...
    public Cursor fetchAll() {
        return mDb.query(DATABASE_TABLE, new String[] { KEY_ROWID, KEY_LABEL,
                ...
                KEY_MINUTE_LABEL, KEY_HOUR_LABEL, KEY_THUMBNAIL_ABSOLUTE_PATH }, null, null, null, null,
                null);
    }
    ...
    public Cursor fetchWhere(String whereClause) {
        return mDb.query(DATABASE_TABLE, new String[] { KEY_ROWID, KEY_LABEL,
                KEY_SECONDS, KEY_STARTED_AT_MILLIS_SINCE_BOOT,
                KEY_MINUTE_LABEL, KEY_HOUR_LABEL, KEY_THUMBNAIL_ABSOLUTE_PATH }, whereClause, null, null,
                null, KEY_ROWID);
    }
